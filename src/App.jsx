  ...
  return (
    <div style={{
      ...
      <footer style={{
        ...
        <br />Follow Aggie's Furniture Shed on <a href="https://www.facebook.com/profile.php?id=100070282226048" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-teal)', textDecoration: 'underline' }}>Facebook</a>
        </p>
